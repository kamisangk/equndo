...
class _UserProfilePageState extends ConsumerState<UserProfilePage>
  ...
  void _openUserSearch() {
    EqunSearchLauncher.open(context);
  }

  void _openEqunTopic(int topicId, {String? title, int? postNumber}) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Widget _buildSummaryTopicItem(ThemeData theme, SummaryTopic topic) {
    return Card(
      ...
      clipBehavior: Clip.antiAlias,
      child: InkWell(
        onTap: () => _openEqunTopic(topic.id, title: topic.title),
        child: Padding(
          padding: const EdgeInsets.all(12),
          child: Row(
            children: [
