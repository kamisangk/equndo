...
class _BookmarksPageState extends ConsumerState<BookmarksPage> {
  ...
  void _onBookmarkTap(Topic topic) {
    ...
    _openTopicRoute(topicId: topic.id, initialTitle: topic.title);
  }

  void _openTopicRoute({required int topicId, String? initialTitle}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) =>
            EqunThreadDetailPage(tid: topicId, initialTitle: initialTitle),
      ),
    );
  }
  ...
  Widget _buildWorkspaceTopicPage(BookmarkWorkspaceTopicTab tab) {
    ...
    return EqunThreadDetailPage(tid: tab.topicId, initialTitle: tab.title);
  }
      ...
      children: [
        Offstage(
          ...
          child: BookmarksListContent(
            ...
            bookmarkNameSuggestions: const [],
            bookmarkNameSuggestionsLoader: () async => const [],
            ...
            selectedBookmarkName: null,
            onSelectedBookmarkName: (_) {},
            ...
            onQuickRenameBookmark: (_, _) async => false,
